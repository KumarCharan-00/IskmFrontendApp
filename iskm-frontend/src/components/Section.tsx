...
export const Section: React.FC<SectionProps> = (props) => {
    ...
    const btnLinkColors: Array<color> = colorCombos.get(props.backgroundType?? "pink")?? ["pink", "blue"];
                    ...
                    <BSCard className="activity-card">
                        ...
                        <BSCard.Body>
                            ...
                            {typeof card.previewText === "string" ? (
                                <p className="activity-description">{card.previewText}</p>
                            ) : (
                                <div className="activity-description">{card.previewText}</div>
                            )}
        ...
        <section className={getSectionClassName()} style={getSectionStyle()}>
            <div className="section-container">
                <div className="section-header">
                    ...
                    { props.content && <p className="section-content mt-4">{props.content}</p> }
                </div>
