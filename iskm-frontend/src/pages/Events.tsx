...
const events = [
    ...
    },
    {
        ...
        previewText: "Distributing Srila Prabhupada's books is the highest form of compassion — illuminating lives with divine knowledge.",
        linkText: "Learn More",
        linkHref: "#",
    },
    {
        ...
        previewText: "The ISKM Proddatur Temple Project is a divine mission to expand and beautify the Lord's home — including altar development and temple infrastructure.",
        linkText: "Learn More",
        linkHref: "#",
    }
];
...
const activitiesCards = [
    {
        ...
        previewText: "Transcendental knowledge through Srila Prabhupada's books"
    },
    {
        imageSrc: "",
    ...
    },
    {
        ...
        previewText: "Observing all major Vaishnava festivals with love and devotion"
    },
    {
        imageSrc: "",
            ...
            <Section
                ...
                subtitle={(
                    <em className="hero-subtitle">
                        <i>Whatever you give, whatever you offer, do it as an offering to Me.</i>
                        <span className="text-end d-block">— Lord Sri Krishna (Bhagavad-gītā 9.27)</span>
                    </em>
                )}
                backgroundType="blue"
